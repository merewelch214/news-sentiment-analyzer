...
app.get('/articles', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var nyt_url, fetch_response, json;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                nyt_url = "https://api.nytimes.com/svc/topstories/v2/home.json?api-key=" + process.env.NYT_API_KEY;
                return [4 /*yield*/, fetch(nyt_url)];
            case 1:
                fetch_response = _a.sent();
                return [4 /*yield*/, fetch_response.json()];
            case 2:
                json = _a.sent();
                console.log(express_1.response.json(json));
                return [2 /*return*/];
        }
    });
}); });
