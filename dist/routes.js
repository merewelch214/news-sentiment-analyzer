...
router.get('/nyt', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response, body, $, nyt_headlines, news;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, node_fetch_1.default('https://nytimes.com/')];
            case 1:
                response = _a.sent();
